...
Не уверены, куда именно писать в вашей схеме параметров, или в проекте уже два «Обозначения» из разных ФОП? Напишите в [Telegram](https://t.me/bimpulsebot?start=article) или через форму на [странице контактов](contacts.html), разберём структуру. Наведение порядка в параметрах и шаблонах есть в [списке услуг](services.html).
