...
Нужен набор кнопок под ваши регламенты, с проверками модели по вашему BIM-стандарту? Напишите в [Telegram](https://t.me/bimpulsebot?start=article) или через форму на [странице контактов](contacts.html), обсудим объём. Что мы делаем на таких задачах, коротко в [услугах](services.html).
