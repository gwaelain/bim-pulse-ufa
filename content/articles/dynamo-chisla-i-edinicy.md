...
Нужен скрипт, который читает модель и отдаёт цифры в правильных единицах и в вашей форме, — напишите в [Telegram](https://t.me/bimpulsebot?start=article) или через [контакты](contacts.html). Разбор модели и оценка занимают день.
