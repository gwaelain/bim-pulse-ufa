...
Данные, которые эти сервисы обрабатывают, обычно приходят из выгрузок Revit, а показывать их удобнее на [дашборде](bim-dashboard.html). Инфраструктуру и внутренние сервисы мы собираем как отдельную работу, коротко об этом в [услугах](services.html), типовые вопросы - в [FAQ](faq.html). Обсудить задачу можно в [Telegram](https://t.me/bimpulsebot?start=article).
