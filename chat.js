  ...
  root.innerHTML =
    ...
    '<div class="bchat-win" hidden>' +
      ...
      '<form class="bchat-form">' +
        ...
        '</button>' +
      '</form>' +
      '<p class="bchat-note">Оставьте email или Telegram в сообщении — команда вернётся с разбором. Или сразу <a href="https://t.me/bimpulsebot?start=chat" target="_blank" rel="noopener">в Telegram</a>.</p>' +
    '</div>';
